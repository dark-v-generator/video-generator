...
from .interfaces import ICoverProxy
...
class PlaywrightCoverProxy(ICoverProxy):
    """Playwright implementation to generate cover images"""

    def __init__(self, title_font_size: int = 150):

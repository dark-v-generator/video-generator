...
segment.write_videofile(
    "output/filter_original.mp4", codec="libx264", preset="fast", logger=None
)
print(
    f"Wrote output/filter_original.mp4 (original, {start:.1f}s–{start+DURATION:.1f}s)"
)
...
vc.clip.write_videofile(
    "output/filter_new.mp4", codec="libx264", preset="fast", logger=None
)
print(
    f"Wrote output/filter_new.mp4 — mirror + zoom={config.zoom} + "

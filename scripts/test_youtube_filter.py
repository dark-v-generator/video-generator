...
vid_url = (
    ...
    else vid.watch_url if hasattr(vid, "watch_url") else str(vid)
)
...
orig_clip.write_videofile(
    "output/yt_original.mp4", codec="libx264", preset="fast", logger=None
)
...
vc.clip.write_videofile(
    "output/yt_filtered.mp4", codec="libx264", preset="fast", logger=None
)
